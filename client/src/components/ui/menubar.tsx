...
const MenubarHeader = React.forwardRef<
  HTMLDivElement,
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "px-3 py-2 text-xs font-semibold text-muted-foreground uppercase tracking-wider border-b border-border/50 bg-muted/30 backdrop-blur-sm",
      className
    )}
    {...props}
  />
